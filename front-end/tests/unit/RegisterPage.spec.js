...
describe('RegisterPage.vue', () => {
  ...
  beforeEach(() => {
    ...
    fieldEmailAddress = wrapper.find('#email')
  ...
  it('should have form inputs bound with data model', () => {
    ...
    const email = 'sunny@surverydemo.com'
  ...
  it('should register when it is a new user', async () => {
    ...
    wrapper.vm.form.email = 'sunny@surverydemo.com'
  ...
  it('should fail it is not a new user', async () => {
    expect.assertions(3)
    // In the mock, only sunny@surverydemo.com is new user
    wrapper.vm.form.username = 'ted'
    wrapper.vm.form.email = 'ted@surverydemo.com'
    wrapper.vm.form.password = 'JestRocks!'
  ...
  it('should fail when the email address is invalid', () => {
    ...
    wrapper.vm.form.email = 'bad-email-address'
    wrapper.vm.form.password = 'JestRocks!'
    wrapper.vm.submitForm()
  ...
  it('should fail when the username is invalid', () => {
    ...
    wrapper.vm.form.email = 'test@surverydemo.com'
    wrapper.vm.form.password = 'JestRocks!'
    wrapper.vm.submitForm()
    expect(registerSpy).not.toHaveBeenCalled()
  })
